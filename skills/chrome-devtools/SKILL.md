...
Screenshots are **automatically compressed** if they exceed 5MB to ensure compatibility with host AI tool (which have 5MB limits). This uses ImageMagick internally:
