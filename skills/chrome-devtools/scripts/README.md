...
**Automatic Compression**: Screenshots >5MB are automatically compressed using ImageMagick to ensure compatibility with host AI tool. Install ImageMagick for this feature:
